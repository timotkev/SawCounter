<div class="panel panel-primary">
	...
	<div class="panel-body">
		<div class="row">
			<div class="col-md-12">
				<form method="post" action="<?php echo base_url('projects/add');?>" id="form" class="form-horizontal">
					<div class="form-group">
				    	<label class="col-md-2">Projects <span class="text-danger">*</span></label>
				    	<div class="col-md-4">
				    		<input type="text" name="projects" class="form-control input-sm" placeholder="Enter Projects Name" value="<?php echo set_value('projects');?>">
				    ...
				    <div class="form-group">
				    	...
				    	<div class="col-md-4">
				    		<input type="text" name="start_projects" class="form-control input-sm tanggal" placeholder="Enter Start Project" value="<?php echo set_value('start_projects');?>">
				    ...
				    <div class="form-group">
				    	...
				    	<div class="col-md-4">
				    		<input type="text" name="end_projects" class="form-control input-sm tanggal" placeholder="Enter End Project" value="<?php echo set_value('end_projects');?>">
				    ...
				    <div class="form-group">
				    	...
				    	<div class="col-md-4">
				    		<input type="text" name="budget" class="form-control input-sm angka" placeholder="Enter Budget" value="<?php echo set_value('budget');?>">
