...
class Ajax_pagination{
	...
	var $uri_segment		= 3;
	var $full_tag_open		= '<div class="pagination pagination-sm">';
   ...
   var $show_count      = true;
	...
	function create_links()
	{
      ...
      if ($this->show_count)
      {
         ...
         $info = '<div style="vertical-align:middle;">Showing ' . ( $curr_offset + 1 ) . ' to ' ;
         ...
         $info .= ' of ' . $this->total_rows . ' <br><br></div>';
	...
	function getAJAXlink( $count, $text) {
		...
		return "<a href=\"javascript:void(0);\"
		         " . $this->anchor_class . "
					...
					$('#". $this->div . "').html(data)" . $this->js_rebind ."; }); 
					$('html, body').animate({scrollTop: $('.display').offset().top}, 500);
					return false;
